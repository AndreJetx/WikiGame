...
export function WikiLogo({ className }: { className?: string }) {
  return (
    ...
    >
      <span className="relative inline-block font-mitshuka text-[1.85rem] md:text-[2.15rem] pt-[0.5em] leading-none">
      ...
      <span className="font-mitshuka text-[1.85rem] md:text-[2.15rem] leading-none pl-[0.18em]">
        Wiki
      </span>
    </span>
  );
